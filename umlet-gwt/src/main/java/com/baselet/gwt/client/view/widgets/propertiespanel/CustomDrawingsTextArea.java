...
public class CustomDrawingsTextArea extends MySuggestBox {
	...
	public void setGridElement(HasPanelAttributes panelAttributeProvider, Redrawable panel) {
		...
		String customDrawingsCode = panelAttributeProvider.getCustomDrawingsCode();
		if (customDrawingsCode == null) {
			customDrawingsCode = DEFAULT_HELPTEXT;
		}
		textArea.setValue(customDrawingsCode);
		oldText = customDrawingsCode;
